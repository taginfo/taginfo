...
INSERT INTO stats (key, value) SELECT 'wikidata_p1282_pcode', count(*) FROM wikidata_p1282 WHERE item LIKE 'P%';
INSERT INTO stats (key, value) SELECT 'wikidata_p1282_qcode', count(*) FROM wikidata_p1282 WHERE item LIKE 'Q%';
...
CREATE INDEX wikidata_labels_item_lang_idx ON wikidata_labels (item, lang);
