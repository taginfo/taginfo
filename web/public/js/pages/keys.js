function page_init() {
    widgetManager.addWidget(createDynamicTable('grid-keys', {
        ...
        colModel: [
            ...
            { display: '<img src="/img/types/node.svg" width="16" height="16" alt=""/> ' + h(texts.osm.nodes), name: 'count_nodes', width: 200, sortable: true, align: 'center', title: h(texts.misc.nodes_tooltip) },
            { display: '<img src="/img/types/way.svg" width="16" height="16" alt=""/> ' + h(texts.osm.ways), name: 'count_ways', width: 200, sortable: true, align: 'center', title: h(texts.misc.ways_tooltip) },
            { display: '<img src="/img/types/relation.svg" width="16" height="16" alt=""/> ' + h(texts.osm.relations), name: 'count_relations',  width: 200, sortable: true, align: 'center', title: h(texts.misc.relations_tooltip) },
            ...
            { display: h(texts.osm.values), name: 'values_all', width: 60, sortable: true, align: 'right', title: h(texts.misc.values_tooltip) },
